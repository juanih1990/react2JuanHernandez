...
const ShopComponentContext = ({ children }) => {
    ...
    return (
        <ShopContext.Provider value={{ item, setItem, category, carrito, setCarrito, clearCarrito, getCarrito, setCategory, setID, ID, getCompra, compra, createOrder, finalizarCompra, setTotal, precioTotal, setUsers, quitarCompra ,ordenDeCompra, datosOrdenCompra}}>
            {children}
        </ShopContext.Provider>
    )
}

export default ShopComponentContext //mi provaider